...
do{
	...
	if(kt==1){
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 3.350"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
		cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 2.050"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
			cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 2.900"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
			cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 2.300"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
			cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 1.400"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
			cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 2.650"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
			cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
		...
		cout<<"dan untuk biaya per kg selanjutnya adalah Rp. 2.700"<<endl;
		cout<<"Berapa berat cargo yang anda ingin kirim?"<<endl;
		cout<<"(dalam satuan kilogram) : ";
			cin>>kgk;
		cout<<"Panjang benda anda (dalam satuan cm): ";
	...
	else{cout<<"Masukkan angka yang sesuai";}
